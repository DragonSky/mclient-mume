...
PluginManager::PluginManager(QObject *parent)
  : QThread(parent) {
    ...
    QHash<QString, QString> *hash = getConfigManager()->applicationSettings();
...
const bool PluginManager::loadPlugin(const QString& libName) {
    ...
    if(!loader->load()) {
	    ...
	    // The plugin will need PluginManager's reference to send events
...
const bool PluginManager::indexPlugins() {
	...
	getConfigManager()->readPluginSettings(e->shortName());
