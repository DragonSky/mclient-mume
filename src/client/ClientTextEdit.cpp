 ...
 */
void ClientTextEdit::viewDimensionsChanged() {
  /*
...
void ClientTextEdit::moveCursor(int diff) {
...
void ClientTextEdit::autoCopySelectedText(bool yes)
{
  if (yes)
    copy();
}

void ClientTextEdit::addText(const QString& str) // TODO: Make this a state machine
{
