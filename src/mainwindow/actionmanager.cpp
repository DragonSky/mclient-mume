...
void ActionManager::createActions() {
  ...
  connect(disconnectAct, SIGNAL(triggered()), Wrapper::self(), SLOT(disconnectSession()));
  ...
  connect(reconnectAct, SIGNAL(triggered()), Wrapper::self(), SLOT(connectSession()) );
  ...
  cutAct->setStatusTip(tr("Cut the current selection's contents to the "
      "clipboard"));
  connect(cutAct, SIGNAL(triggered()), cliMgr->getTextView(), SLOT(cut()));

  copyAct = new QAction(QIcon(":/editcopy.png"), tr("&Copy"), this);
  copyAct->setShortcut(tr("Ctrl+C"));
  copyAct->setStatusTip(tr("Copy the current selection's contents to the "
      "clipboard"));
  connect(copyAct, SIGNAL(triggered()), cliMgr->getTextView(), SLOT(copy()));

  pasteAct = new QAction(QIcon(":/editpaste.png"), tr("&Paste"), this);
  pasteAct->setShortcut(tr("Ctrl+V"));
  pasteAct->setStatusTip(tr("Paste the clipboard's contents into the current "
      "selection"));
  connect(pasteAct, SIGNAL(triggered()), cliMgr->getInputBar(), SLOT(paste()));
  ...
  connect(ClientManager::self()->getTextView(), SIGNAL(copyAvailable(bool)),
