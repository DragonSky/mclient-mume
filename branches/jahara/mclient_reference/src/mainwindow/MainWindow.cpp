...
MainWindow::~MainWindow() {
  qDebug() << "pm" << getPluginManager() << "cm" << getPluginManager()->getCommandManager();;  
  getPluginManager()->getCommandManager()->~CommandManager();
  qDebug() << "pm" << getPluginManager();

  qDebug() << "pm" << getPluginManager() << "cm" << getPluginManager()->getConfigManager();
  getPluginManager()->getConfigManager()->~ConfigManager();
  qDebug() << "pm" << getPluginManager();
...
void MainWindow::start() {
  getPluginManager()->initSession(_currentProfile);
}
...
void MainWindow::closeEvent(QCloseEvent *event)
{
  ...
  if (maybeSave()) {
    getPluginManager()->stopSession(_currentProfile);
    writeSettings();
    event->accept();
  } else {
    event->ignore();
...
{
  _pluginManager->getConfigManager()->writeApplicationSettings();
  /*
