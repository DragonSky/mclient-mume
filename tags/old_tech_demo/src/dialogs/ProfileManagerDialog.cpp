...
void ProfileManagerDialog::deleteClicked ()
{
  ...
  if (QMessageBox::warning (this, tr("Delete profile"),
      tr("Do you really want to delete profile %1?").arg(mgr->visibleProfileName (profile)),
...
void ProfileManagerDialog::duplicateClicked ()
{
  ...
  QString newName = QInputDialog::getText(this,
                                          ...
                                          QLineEdit::Normal,
                                          mgr->visibleProfileName (profile),
                                          &ok
                                         );
  if (newName.isEmpty())
    return;
...
ProfileManagerDialog::ProfileManagerDialog(QItemSelectionModel *sel, QWidget*parent) : QDialog(parent)
{
  ...
  // Synchronize Selection Models if it was called from ConnectDialog
  if (sel) {
