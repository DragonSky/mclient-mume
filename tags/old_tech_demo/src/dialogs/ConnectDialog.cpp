...
QString ConnectDialog::selectedProfile ()
{
...
void ConnectDialog::playClicked() {
...
void ConnectDialog::relayLoadProfile(const QString& profile)
{
...
void ConnectDialog::profileClicked() {
...
void ConnectDialog::selectionChanged (const QItemSelection &index)
{
  //enable/disable Connect button
  playButton->setEnabled(index.indexes().empty() ? false : true);
}

void ConnectDialog::doubleClicked(const QModelIndex &index)
{
  if (index.isValid ())
    playButton->click();
}
...
void ConnectDialog::createDefaultProfile()
{
