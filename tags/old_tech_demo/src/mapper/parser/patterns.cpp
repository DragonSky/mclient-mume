...
{
	for ( QStringList::iterator it = Config().moveCancelPatternsList.begin(); 
		it != Config().moveCancelPatternsList.end(); ++it ) 
...
{
	for ( QStringList::iterator it = Config().moveForcePatternsList.begin(); 
		it != Config().moveForcePatternsList.end(); ++it ) 
		if (matchPattern(*it, str)) return true;
	return false;
}
...
{
	for ( QStringList::iterator it = Config().noDescriptionPatternsList.begin(); 
		it != Config().noDescriptionPatternsList.end(); ++it ) 
		if (matchPattern(*it, str)) return true;
	return false;
}
...
{
	for ( QStringList::iterator it = Config().dynamicDescriptionPatternsList.begin(); 
		it != Config().dynamicDescriptionPatternsList.end(); ++it ) 
		if (matchPattern(*it, str)) return true;
	return false;	
}
...
{
	if (matchPattern(Config().exitsPattern, str)) return true;
	return false;
}

bool Patterns::matchScoutPatterns(QString& str)
{
	if (matchPattern(Config().scoutPattern, str)) return true;
	return false;
}

bool Patterns::matchPasswordPatterns(QByteArray& str)
{	
	if (matchPattern(Config().passwordPattern, str)) return true;
	return false;
}

bool Patterns::matchPromptPatterns(QByteArray& str)
{
	if (matchPattern(Config().promptPattern, str)) return true;
	return false;
}

bool Patterns::matchLoginPatterns(QByteArray& str)
{
	if (matchPattern(Config().loginPattern, str)) return true;
	return false;
}

bool Patterns::matchMenuPromptPatterns(QByteArray& str)
{
	if (matchPattern(Config().menuPromptPattern, str)) return true;
	return false;
}
